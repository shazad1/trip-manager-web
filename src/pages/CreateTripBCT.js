...
export default function CreateTripBCT() {
    ...
    React.useEffect(async () => {
        ...
        let response = await fetch("https://asia-southeast2-tawtripmanager.cloudfunctions.net/getDataToBuildTrip?clientNumber=2", {
        });
    ...
    return (
      ...
      <CssBaseline />
            ...
            <Box sx={{ width: '90%', marginTop: 5, backgroundColor:"secondary" }}>
                <Stepper color='primary' activeStep={activeStep}>
